...
var G__10717 = (i__5770__auto___10715 + (1));
i__5770__auto___10715 = G__10717;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.set.union.cljs$lang$applyTo = (function (seq10573){
...
default:
var args_arr__5794__auto__ = [];
var len__5769__auto___10723 = arguments.length;
var i__5770__auto___10725 = (0);
while(true){
if((i__5770__auto___10725 < len__5769__auto___10723)){
args_arr__5794__auto__.push((arguments[i__5770__auto___10725]));

var G__10727 = (i__5770__auto___10725 + (1));
i__5770__auto___10725 = G__10727;
continue;
} else {
}
break;
...
var bubbled_sets = clojure.set.bubble_max_key((function (p1__10580_SHARP_){
...
/** @this {Function} */
(clojure.set.intersection.cljs$lang$applyTo = (function (seq10583){
...
default:
var args_arr__5794__auto__ = [];
var len__5769__auto___10744 = arguments.length;
var i__5770__auto___10745 = (0);
while(true){
if((i__5770__auto___10745 < len__5769__auto___10744)){
args_arr__5794__auto__.push((arguments[i__5770__auto___10745]));

var G__10746 = (i__5770__auto___10745 + (1));
i__5770__auto___10745 = G__10746;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.set.difference.cljs$lang$applyTo = (function (seq10595){
...
var old = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10612,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10612,(1),null);
...
var vec__10667 = (((cljs.core.count(xrel) <= cljs.core.count(yrel)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [xrel,yrel], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [yrel,xrel], null));
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10667,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10667,(1),null);
var idx = clojure.set.index(r,ks);
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret,x){
var found = (function (){var G__10673 = cljs.core.select_keys(x,ks);
...
var vec__10679 = (((cljs.core.count(xrel) <= cljs.core.count(yrel)))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [xrel,yrel,clojure.set.map_invert(km)], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [yrel,xrel,km], null));
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10679,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10679,(1),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10679,(2),null);
var idx = clojure.set.index(r,cljs.core.vals(k));
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret,x){
var found = (function (){var G__10694 = clojure.set.rename_keys(cljs.core.select_keys(x,cljs.core.keys(k)),k);
...
return (((cljs.core.count(set1) <= cljs.core.count(set2))) && (cljs.core.every_QMARK_((function (p1__10700_SHARP_){
...
return (((cljs.core.count(set1) >= cljs.core.count(set2))) && (cljs.core.every_QMARK_((function (p1__10705_SHARP_){
