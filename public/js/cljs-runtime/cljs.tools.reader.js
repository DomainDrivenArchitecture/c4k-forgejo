...
var G__8311 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__8311;
continue;
}
break;
...
var G__7865 = (function (){var G__7869 = rdr;
...
if(("\\" === ch__$1)){
var ch_8321__$2 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if((ch_8321__$2 == null)){
...
var G__8323 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch__$1 = G__8323;
continue;
}
}
...
var vec__7898 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7898,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7898,(1),null);
...
var G__8368 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,form);
a = G__8368;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__7905 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__7906 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__7906);

try{return cljs.tools.reader.read_delimited_internal(kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__7905);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__7908 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7908,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7908,(1),null);
var the_list = cljs.tools.reader.read_delimited(new cljs.core.Keyword(null,"list","list",765357683),")",rdr,opts,pending_forms);
var vec__7911 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7911,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7911,(1),null);
...
var vec__7915 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7915,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7915,(1),null);
...
var vec__7918 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7918,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7918,(1),null);
...
var vec__7927 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7927,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7927,(1),null);
...
var vec__7930 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7930,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7930,(1),null);
...
var sb = (function (){var G__7937 = (new goog.string.StringBuffer());
...
var G__8392 = (function (){var G__7941 = sb;
G__7941.append(ch);

return G__7941;
})();
var G__8393 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__8392;
ch = G__8393;
continue;
}
...
switch (G__7951) {
case "\\":
var G__8400 = (function (){var G__7952 = sb;
G__7952.append(cljs.tools.reader.escape_char(sb,reader));

return G__7952;
})();
var G__8401 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__8400;
ch = G__8401;
continue;
...
break;
default:
var G__8405 = (function (){var G__7953 = sb;
G__7953.append(ch);

return G__7953;
})();
var G__8406 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__8405;
ch = G__8406;
continue;
...
var vec__7957 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7957,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7957,(1),null);
...
var vec__7961 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7961,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7961,(1),null);
...
var vec__7984 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7984,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7984,(1),null);
...
var vec__7990 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7990,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7990,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta((cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms)));
if(cljs.core.map_QMARK_(m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata(rdr,m);
...
var vec__7996 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7996,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7996,(1),null);
...
var vec__7999 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7999,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7999,(1),null);
...
var G__8005 = sym;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__8005)){
return Number.NaN;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__8005)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__8005)){
...
var _STAR_suppress_read_STAR__orig_val__8015 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__8016 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__8016);

try{var form = (function (){var G__8017 = rdr;
var G__8018 = false;
var G__8019 = cljs.tools.reader.READ_EOF;
var G__8020 = ")";
var G__8021 = opts;
var G__8022 = pending_forms;
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__8015);
}});
...
var feature = (function (){var G__8024 = rdr;
var G__8025 = false;
var G__8026 = cljs.tools.reader.READ_EOF;
var G__8027 = ")";
var G__8028 = opts;
var G__8029 = pending_forms;
...
var G__8030 = (function (){var G__8032 = rdr;
var G__8033 = false;
var G__8034 = cljs.tools.reader.READ_EOF;
var G__8035 = ")";
var G__8036 = opts;
var G__8037 = pending_forms;
...
var G__8496 = matched;
var G__8497 = cljs.tools.reader.read_suppress(first_line,rdr,opts,pending_forms);
matched = G__8496;
finished = G__8497;
continue;
} else {
...
if(cljs.core.truth_(and__5043__auto__)){
var G__8051 = new cljs.core.Keyword(null,"read-cond","read-cond",1056899244).cljs$core$IFn$_invoke$arity$1(opts);
var fexpr__8050 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"preserve","preserve",1276846509),null,new cljs.core.Keyword(null,"allow","allow",-1857325745),null], null), null);
...
var _STAR_suppress_read_STAR__orig_val__8054 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__8055 = (function (){var or__5045__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__8055);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__8054);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character(rdr);
}
...
var arg_env_orig_val__8063 = cljs.tools.reader.arg_env;
var arg_env_temp_val__8064 = cljs.core.sorted_map();
(cljs.tools.reader.arg_env = arg_env_temp_val__8064);

try{var form = (function (){var G__8065 = (function (){var G__8070 = rdr;
cljs.tools.reader.reader_types.unread(G__8070,"(");
...
var G__8517 = (i + (1));
var G__8518 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(args,(function (){var or__5045__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__8063);
}});
/**
...
var ch = temp__5802__auto__;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("@",ch)){
return cljs.tools.reader.wrapping_reader(new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null))((function (){var G__8086 = rdr;
...
var G__8539 = cljs.core.next(s__$1);
var G__8540 = ret;
s__$1 = G__8539;
r = G__8540;
continue;
...
var G__8542 = cljs.core.next(s);
var G__8543 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(key_vals,cljs.core.key(e)),cljs.core.val(e));
s = G__8542;
key_vals = G__8543;
continue;
} else {
...
return (new cljs.core.List(null,new cljs.core.Symbol("cljs.core","with-meta","cljs.core/with-meta",749126446,null),(new cljs.core.List(null,ret,(new cljs.core.List(null,(function (){var G__8104 = cljs.core.meta(form);
...
var gensym_env_orig_val__8143 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__8144 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__8144);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__8143);
}});
cljs.tools.reader.read_namespaced_map = (function cljs$tools$reader$read_namespaced_map(rdr,_,opts,pending_forms){
var vec__8152 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8152,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8152,(1),null);
...
var temp__5802__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(token,":"))?cljs.core.ns_name(cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(":",cljs.core.first(token)))?(function (){var G__8156 = token;
var G__8156__$1 = (((G__8156 == null))?null:cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__8156,(1)));
var G__8156__$2 = (((G__8156__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__8156__$1));
var G__8156__$3 = (((G__8156__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__8156__$2));
var G__8156__$4 = (((G__8156__$3 == null))?null:cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__8156__$3));
if((G__8156__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns(G__8156__$4);
}
})():(function (){var G__8161 = token;
var G__8161__$1 = (((G__8161 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__8161));
if((G__8161__$1 == null)){
return null;
} else {
...
var vec__8162 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8162,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8162,(1),null);
...
var G__8182 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
...
var G__8184 = tag;
var G__8185 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__8229,reader){
var map__8230 = p__8229;
var map__8230__$1 = cljs.core.__destructure_map(map__8230);
var opts = map__8230__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__8230__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
